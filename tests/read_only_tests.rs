...
fn test_neuron_info_structure() {
    ...
    let neuron = NeuronInfo {
        ...
        active: true,
        stake: bittensor_rs::Rao::from(1000000u128),
        stake_dict: HashMap::new(),
        total_stake: bittensor_rs::Rao::from(1000000u128),
        root_stake: bittensor_rs::Rao::ZERO,
        stake_weight: 0,
        rank: 0.5,
        emission: bittensor_rs::Rao::from(100u128),
        incentive: 0.5,
        consensus: 0.8,
        trust: 0.9,
...
fn test_subnet_info_structure() {
    ...
    let subnet = SubnetInfo {
        netuid: 1,
        neuron_count: 256,
        total_stake: bittensor_rs::Rao::from(1000000000u128),
        emission: bittensor_rs::Rao::ZERO,
